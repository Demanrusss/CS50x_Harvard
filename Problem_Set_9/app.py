...
def quote():
    ...
    if request.method == "GET":
        ...
        if stocks_symbol == None:
            return apology("Cannot find such symbol", 404)
        return render_template("quoted.html", stocks_symbol=stocks_symbol)
...
def register():
    if request.method == "GET":
        ...
        if not user or user == " ":
            return apology("No value in username", 403)
        ...
        if user_session != None:
            ...
            return apology("Such username already exists", 403)
